var vm = new Vue({
  ...
  created() {
    ...
    this.vinosTintos.push({
        big: false,
        imatge:"./fotos/vinos/edulis.png", 
        marca: "Edulis de Altanza",
        denominacio: "D.O. Rioja",
        calidad: ["Criança", "Crianza", "Aging ", "Vieillissement"],
        preu: ["14.75", "0"]}
    );
	...
	this.vinosTintos.push({
        big: false,
        imatge:"./fotos/vinos/fortius.png", 
        marca: "Fortius",
        denominacio: "D.O. Navarra",
        calidad: ["Gran reserva", "Gran reserva", "Grand Reserve ", "Grande Réserver"],
        preu: ["16.00", "0"]}
    );
    this.vinosTintos.push({
        big: false,
    ...
    this.vinosRosados.push({
        big: false,
        imatge:"./fotos/vinos/legaris.png", 
        marca: "Legaris",
        denominacio: "D.O. Ribera del Duero",
        calidad: ["", "", "", ""],
        preu: ["13.85", "0"]}
