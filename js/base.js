var vm = new Vue({
  ...
  data: {
      ...
      listaAperitivos: [],
      listaPostres: [],
      explicacionBocatas: ["* Ingredients extra en entrepà normal <b>+1.00</b> <br> (Formatge, ceba, beicon)  ","* Ingredientes extra en bocadillo normal <b>+1.00</b> <br> (Queso, cebolla, beicon)","* Unless otherwise stated<br>Extra ingredients (Cheese, onion, bacon) <b>+1.00</b>","*Sauf indication contraire<br>Suppléments (fromage, oignon, bacon) <b>+1.00</b> "],
  ...
  created() {
    ...
    this.bocadillosCalientes.push({
        ...
        desripcio: ["Amb ceba, formatge, enciam, tomata i beicon<br>En baguette +1.00€","Con cebolla, queso, lechuga, tomate y beicon<br>En baguette +1.00€","With onion, cheese, lettuce, tomato and bacon<br>On baguette +1.00€","Avec oignon, fromage, laitue, tomate et bacon<br>Sur baguette +1.00€"], 
        preu: ["7.75", "0"]
    });
    this.bocadillosCalientes.push({
        big: false,
    ...
    this.bocadillosCalientes.push({
        ...
        desripcio: ["Formatge o ceba +1.00€<br>Pernil o tonyina +1.75€ &nbsp; &nbsp; Anxoves +3.50€","Queso o cebolla +1.00€<br>Jamón o atún +1.75€ &nbsp; &nbsp; Anchoas +3.50€","Cheese or onion +1.00€<br>Ham or tuna +1.75€ &nbsp; &nbsp; Anchovies + 3.50€","Fromage ou oignon +1.00€<br>Jambon ou thon +1,75€ &nbsp; &nbsp; Anchois +3,50€"], 
        preu: ["6.00", "4.50"]
    });
    this.bocadillosCalientes.push({
        big: false,
    ...
    this.racionesNormales.push({
        ...
        desripcio: ["12 unitats","12 unidades","12 units","12 unités"], 
        preu: ["20.00", "0"]
    });
    ...
    this.platosCombinados.push({
        ...
        desripcio: ["Mongetes amb butifarra i beicon","Judias con butifarra y beicon",'Beans with "Botifarra" (large Catalan pork sausage)','Haricots aux "Botifarra" (Longue saucisse de porc catalane)'], 
        preu: ["12.85", "0"]}
    );
    this.platosCombinados.push({
        big: false,
    ...
    this.vinosTintos.push({
        big: false,
        imatge:"./fotos/vinos/encanteri.png", 
        marca: "Encanteri",
        denominacio: "D.O. Empordà",
        calidad: ["Criança", "Crianza", "Aging ", "Vieillissement"],
        preu: ["19.85", "0"]}
    ...
    this.vinosTintos.push({
        big: false,
        imatge:"./fotos/vinos/campillo.png", 
        marca: "Campillo",
    ...
    this.vinosTintos.push({
        big: false,
        imatge:"./fotos/vinos/vinapuebla.png", 
        marca: "Viña Puebla",
        denominacio: "D.O. Vinos de la tierra de Extremadura ",
        calidad: ["Criança Baixa producció 12 messos en barrica.", "Crianza Baja producción 12 meses en barrica", "Aging 12 months in barrel", "Vieillissement 12 mois en chêne"],
        preu: ["15.85", "0"]}
    );
    ...
    this.vinosBlancos.push({
        big: false,
        imatge:"./fotos/vinos/murri.png", 
        marca: "Murri",
        denominacio: "D.O. Empordà",
        calidad: ["Garnatxa i Macabeu", "Garnacha y Macabeo", "Grenache and Macabeo", "Grenache et Macabéo"],
        preu: ["18.00", "0"]}
    );
    this.vinosBlancos.push({
        big: false,
    ...
    this.vinosRosados.push({
        big: false,
        imatge:"./fotos/vinos/enaterosado.png", 
        marca: "Enate",
        denominacio: "D.O. Somontano",
        calidad: ["", "", "", ""],
        preu: ["16.85", "0"]}
    ...
    this.vinosRosados.push({
        big: false,
        imatge:"./fotos/vinos/trapella.png", 
        marca: "Trapella",
        denominacio: "D.O. Empordà",
        calidad: ["", "", "", ""],
        preu: ["18.00", "0"]}
